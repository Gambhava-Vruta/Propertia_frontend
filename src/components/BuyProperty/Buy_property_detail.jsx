...
//           <img
//             src={`https://localhost:7117/images/${property.images[0]}`}
//             alt="property"
//           />
//         </div>
//       )}
...
//         `https://localhost:7117/api/property-inquiries/property/${id}`
//       );
//       if (data) {
...
//     try {
//       await fetchWithAuth(
//         `https://localhost:7117/api/property-inquiries/reply/${inquiryId}`,
//         {
//           method: 'PUT',
